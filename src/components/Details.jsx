...
function Details() {
    ...
    return (
        <Box component="section" className="details" sx={{ 
            ...
            <Box sx={{ position: 'relative', zIndex: 1, maxWidth: '1200px', mx: 'auto', width: '100%' }}>

                <Grid container spacing={{ xs: 3, sm: 4, md: 8 }} justifyContent="center" alignItems="stretch">
                    <Grid item xs={12} sm={10} md={6} sx={{ display: 'flex', minWidth: 0 }}>
                        <motion.div
                            initial="hidden"
                            whileInView="visible"
